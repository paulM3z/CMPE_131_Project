...
MAX_EVENT_CAPACITY: int = int(os.getenv("MAX_EVENT_CAPACITY", "10000"))
EVENT_REMINDER_HOURS_BEFORE: int = int(os.getenv("EVENT_REMINDER_HOURS_BEFORE", "24"))
EVENT_REMINDER_CHECK_SECONDS: int = int(os.getenv("EVENT_REMINDER_CHECK_SECONDS", "3600"))
